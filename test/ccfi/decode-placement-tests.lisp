...
(define-test test-ccfi-scan-invalid-row-1 ()
  (let ( (got-error nil))
    (handler-case (cfi::parse-row "")
      (cfi::invalid-placement-error () (setf got-error t)))
...
(define-test test-ccfi-scan-invalid-row-2 ()
  (let ( (got-error nil))
    (handler-case (cfi::parse-row "xabcdo")
      (cfi::invalid-placement-error () (setf got-error t)))
...
(define-test test-ccfi-decode-board-1 ()
	     (let ( (got-error nil))
	       (handler-case (cfi::decode-placement "" nil nil)
		 (cfi::invalid-placement-error () (setf got-error t)))
