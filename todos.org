...
** DONE Establish package for engine
** TODO boardformatter should not provide default implementation of some methods
** TODO Split boardformatter into interface decl and console-board-formatter packages
** TODO Establish package for gamecommands (requires some refactoring)
** TODO Re-think format-context function
